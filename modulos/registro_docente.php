            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeIn">
                        ...
                        <p>Formulario para registrar un docente</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-5 contact-form wow fadeInLeft">
                        <form role="form" name="registro_docente" action="../procesos/registro_personal.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="especialidad" placeholder="Especialidad" class="contact-subject" id="contact-subject">
                            </div>
                    ...
                    <div class="col-sm-5 contact-form wow fadeInRight">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="asignatura" placeholder="Asignatura" class="contact-subject" id="contact-subject">
                            </div>
                        </form>
                    </div>
                </div>
