...
<?php if(isset($_SESSION['user'])){ ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeInLeftBig">
                        <h1>Personal obrero registrado</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table style="width:1900px; margin-top:0;" >
          ...
          $obrero = mysql_query("SELECT * FROM persona, obrero WHERE persona.cedula = obrero.cedula ");

          while ($row = mysql_fetch_assoc($obrero))
          {
          ?>
          <tr>
            ...
            <td style="text-align:center;"><a href="registro_obrero.php?cedula=<?=$row['cedula']?>">Actualizar</a> - <a href="../procesos/delete.php?cedula=<?=$row['cedula']?>&categoria=Obrero">Eliminar</a></td>
          </tr>
         <?php } ?>
        </table>
      </div>
